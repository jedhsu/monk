use crate::{
    domains::Transition, fa::StateActionUpdate, policies::Policy, Enumerable,
    Function, Handler,
};
use std::f64;
...
where
    ...
    T: Handler<StateActionUpdate<&'m S, usize>>
        + Function<(&'m S, usize), Output = f64>,
